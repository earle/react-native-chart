...
_dataPoint,3),_x=_dataPoint2[0],dataPoint=_dataPoint2[1],color=_dataPoint2[2];
var backgroundColor=color||_this.props.color||C.BLUE;
...
var width=WIDTH/data.length*_this.props.horizontalScale*1.5*widthPercent;
